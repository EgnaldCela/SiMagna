...
img_bgr = cv2.imread("./INTERFACE/placeholder.jpeg")
img_rgb = cv2.cvtColor(img_bgr, cv2.COLOR_BGR2RGB)


placeholder_img = cv2.imread("./INTERFACE/placeholder.jpeg")
...
def start(img_fridge):
    ...
    # input: list of ingredients -> output: list of recipes IDs
    ...
    # or get full recipe detail and acces preparation time, cost and link woth index?

    return recipes # list with 3 elements
...
with gr.Blocks(theme=mytheme) as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            out = gr.Text(label = 'Here you have 3 recipes you might like:', value = '''
                            1. {recipe1_name}
    ...
    '''@button_cook.click(inputs=[inp], outputs=[out])
    def start(inp):
        ...
        return ...'''


    @button_faster.click(inputs=[], outputs=[])
    def new_recipes():
        ...
        return 
