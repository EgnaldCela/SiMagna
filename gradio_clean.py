...
def find_recipes(img_fridge):
    ...
    return recipes_string, gr.update(value=rec1, link=link1), gr.update(value=rec2, link=link2), gr.update(value=rec3, link=link3)
...
with gr.Blocks(theme=mytheme) as demo:
    ...
    with gr.Row():
        ...
        button_cook.click(fn = find_recipes, inputs=inp, outputs=[out, b_link1, b_link2, b_link3], show_progress='full')
